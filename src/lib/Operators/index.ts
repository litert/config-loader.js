...
export function getAllBuiltInOperators(): dL.IOperator[] {
    ...
    return [
        new EnvironmentVariableOperator(),
        new DecodeBase64Operator(),
        new DecodeHexOperator(),
        new ImportOperator(),
        new ExtendsOperator(),
        new ImportTextFileOperator(),
        new ImportBinaryFileOperator(),
        new ResolvePathOperator(),
    ];
}
