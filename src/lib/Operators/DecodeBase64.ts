...
class DecodeBase64BlockOperator implements dL.IBlockOperator {
    ...
    public processSync(operand: string, ctx: dL.IOperatorContext): void {
        ...
        const val = Buffer.from(operand, 'base64');
 ...
 * @mode block
 *
 * @syntax `"$[[base64:<base64-encoded-string>]]"`
 */
export class DecodeBase64Operator implements dL.IOperator {
    ...
    public readonly modes = {
        [cL.EOperatorMode.BLOCK]: new DecodeBase64BlockOperator(),
    };
}
